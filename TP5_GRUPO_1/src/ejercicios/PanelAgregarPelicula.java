...
public class PanelAgregarPelicula extends JPanel {
    ...
    public PanelAgregarPelicula() {
        ...
        Categoria cat2 = new Categoria(2, "Acción");
        Categoria cat3 = new Categoria(3, "Suspenso");
        Categoria cat4 = new Categoria(4, "Romántica");
    ...
    private boolean validarYGuardar() {
        ...
        if (selectedGenero == null) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un género válido.", "Error", JOptionPane.ERROR_MESSAGE);
            return false;
        }
